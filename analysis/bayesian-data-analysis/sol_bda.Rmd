...
RT estimate: is 50ms change per month in spoken language
...
We get the Bayes Factor using the Savage-Dickey moethod, which takes the ratio of the density of the posterior and prior when the slope
parameter is zero. 
