...
```{r load data}
# Load data
d <- read.csv("../eye_movements/sol_ss_all_600_2500.csv")
...
We get the Bayes Factor using the Savage-Dickey moethod, which takes the ratio of the density of the posterior and prior when the slope parameter is zero. 
...
The data is 1.6 times as likely under the linear model. This is the weakest evidence among all four linear associations. 
...
samples <- jags(data = dataList_age_rt_nolat, parameters.to.save = parameters,
                model.file="rt_model_nomixture.txt", n.chains=nChains, 
                n.iter=nIter, n.burnin = burnInSteps,
                n.thin=1, DIC=F)
