...
ss <- ss %>% 
    mutate(C_D_prop = ifelse(C_T_prop == 1, 0, C_D_prop),
           exclude_chance_shifter = ifelse(Sub.Num %in% c("30050", 
                                                          "30018", 
                                                          "30051", 
                                                          "30086", 
                                                          "30088"), 
...
Hmisc::rcorr(as.matrix(select(ss_kids, mean_accuracy, C_T_prop, mean_correct_rt,
...
t.test(mean_correct_rt ~ age_group, data=ss_kids)
```
