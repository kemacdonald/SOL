...
```{r}
v1_df <- readiChart("sol-ichart-v1-processed.txt")
v2_df <- readiChart("sol-ichart-v2-processed.txt")
```
...
```{r}
write.csv(v1_v2_df, file = "sol-ichart-merged.csv", row.names = F, na = "NA")
```