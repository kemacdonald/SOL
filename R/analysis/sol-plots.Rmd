...
```{r}
fig2 <- ggdraw() +
  draw_plot(gt, x = 0, y = .5, width = 0.55, height = .5) +
  draw_plot(item_plot_adults, x = 0.6, y = 0.55, width = .3, height = .45) + 
  draw_plot(gt_kids, x = 0, y = 0, width = 0.55, height = .5) +
  draw_plot(item_plot_kids, x = 0.6, y = 0.03, width = .3, height = .45) 
```
