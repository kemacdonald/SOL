...
library(langcog); library(knitr); library(R2jags); library(dplyr);
library(ggplot2); library(tidyr); library(polspline); library(magrittr);
library(stringr); theme_set(theme_bw())
```

```{r functions}
window_simulations_fun <- function(list_of_dfs, predictor, outcome, 
...
model_path <- "analysis/bayesian-data-analysis/models/"
```
